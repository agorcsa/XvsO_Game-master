...
import static com.example.xvso.ui.BaseActivity.KEY;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    public void playMusic() {
        ...
        Runnable myRunnable = new Runnable() {
            public void run() {
                mediaPlayer = android.media.MediaPlayer.create(com.example.xvso.uifirebase.BaseActivity.this, R.raw.orbitbeat);
                mediaPlayer.start();
